...
## 🧱 Project Structure # ATTENTION: THIS IS SUBJECT TO CHNAGE!! THIS IS NOT FINAL.
...
│   │   └── lstm.py
│   ├── recommenders/       # Collaborative filtering models
│   └── utils/              # Helper functions
├── scripts/                # Scripts for training/testing models
│   └── train_model.py
